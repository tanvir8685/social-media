...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        {user?.uid?  <li className='font-semibold' ><button onClick={handleLogOut}>LogOut</button></li>:<li className='font-semibold' ><Link to='/login'>LogIn</Link></li>}
    ...
    return (
        ...
        <div>
            <div>
            <div className="navbar h-20  bg-base-100 bg-gray-500 text-white">
